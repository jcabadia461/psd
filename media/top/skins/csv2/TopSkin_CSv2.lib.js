...
(function(namespace){
    ...
    TopSkin_CSv2.prototype = new emic.top.ui.UISkinBase();
    ...
    function TopSkin_CSv2 (){
        ...
        var _URL_TEMPLATE = "/psdmedia/media/top/skins/csv2/assets/template.html",
            _URL_STYLE = "/psdmedia/media/top/skins/csv2/assets/estilos.css",
            _URL_STYLE_EMBED = "/psdmedia/media/top/skins/csv2/assets/estilos_embed.css",
        ...
        var _loadCSS = function(){                                  // Loading CSS main file
            ...
            if(soyEmbed){
                _modoPlayer.className = _modoPlayer.className.replace("cs-grande","player-embebido");

                _URL_STYLE = "/psdmedia/media/top/skins/csv2/assets/estilos2.css";
            ...
            /*if(((psd.framework.ua.msie!=null)&&(psd.framework.ua.msie))){
                ...
                head.innerHTML += '<link rel="stylesheet" type="text/css" href="http://playser.player-top.prisasd.com/psdmedia/media/top/skins/csv2/assets/css/player_desktop.css" /><link rel="stylesheet" media="screen and (max-width: 999px)" href="http://playser.player-top.prisasd.com/psdmedia/media/top/skins/csv2/assets/css/player_tablet.css" /><link rel="stylesheet" media="screen and (max-width: 730px)" href="http://playser.player-top.prisasd.com/psdmedia/media/top/skins/csv2/assets/css/player_tablet_movil.css" /><link rel="stylesheet" media="screen and (max-width: 650px)" href="http://playser.player-top.prisasd.com/psdmedia/media/top/skins/csv2/assets/css/player_movil.css" />';
        ...
        var onDataCompleteEmisoras = function (evt) {
            if (evt.result.parserResult.code == _CODE_NUM_PARSER_OK)
            {
                ...
                for(zona in o_zonas["Provincia"]){
                    ...
                    if(_selectZona){
                        if((o_zonas.Provincia[zona].IdPais==_codigopais)){
        ...
        var _asignElements = function(){
            ...
            _btnCerrarEmail.onclick = (function (that) {//--jacob email
                return  function () {
        ...
        var setSkin = function()
        {
            ...
            if(_data.uiData.skinData.soy_embed!=undefined){
                soyEmbed = _data.uiData.skinData.soy_embed;
            }
            ...
            _btnEmbed.onclick = function () {
                ...
                */
                ...
                codigo_iframe = codigo_iframe.replace("SSS",_data.genericData.id_player);
            ...
            _btnAplicar.onclick = function(){
                ...
                //config.id_media = o_zonas["Provincia"][_selectZona.selectedIndex].emisoras[_selectEmisora.selectedIndex].TagName;
    ...
    namespace.TopSkin_CSv2 = TopSkin_CSv2;
