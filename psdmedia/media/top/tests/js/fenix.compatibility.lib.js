(function(window) 
{
    ...
    /**
     * Event to be dispatched on clipBegin
     */
    MediaEvent.BEGIN = "clipBegin";
    
    /**
     * Script to be run when a file is ready to start playing (when it has buffered enough to clipBegin)
     */
    MediaEvent.CAN_PLAY = "canplay";
    
    /**
     * Script to be run when a file can be played all the way to the clipEnd without pausing for buffering
     */
    ...
    /**
     * Script to be run when the media has reach the clipEnd (a useful event for messages like "thanks for listening")
     */
