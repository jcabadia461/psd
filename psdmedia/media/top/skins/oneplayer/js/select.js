! function(a, b) {
    ...
    ! function(a) {
            ...
            var h, i = this.each(function() {
                ...
                if (b.is("select")) {
                    ...
                    if (c) {
                        ...
                        var j = a.extend({}, f.DEFAULTS, a.fn.selectpicker.defaults || {}, b.data(), i);
                        j.template = a.extend({}, f.DEFAULTS.template, a.fn.selectpicker.defaults ? a.fn.selectpicker.defaults.template : {}, b.data().template, i.template), b.data("selectpicker", c = new f(this, j, g))
                    }
        ...
        var f = function(c, d, e) {
            b.useDefault || (a.valHooks.select.set = b._set, b.useDefault = !0), e && (e.stopPropagation(), e.preventDefault()), this.$element = a(c), this.$newElement = null, this.$button = null, this.$menu = null, this.$lis = null, this.options = d, null === this.options.title && (this.options.title = this.$element.attr("title")), this.val = f.prototype.val, this.render = f.prototype.render, this.refresh = f.prototype.refresh, this.setStyle = f.prototype.setStyle, this.selectAll = f.prototype.selectAll, this.deselectAll = f.prototype.deselectAll, this.destroy = f.prototype.destroy, this.remove = f.prototype.remove, this.show = f.prototype.show, this.hide = f.prototype.hide, this.init()
        };
        f.VERSION = "1.11.2", f.DEFAULTS = {
            ...
            createDropdown: function() {
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    g = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + e(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search"></div>' : "",
            ...
            createLi: function() {
                var b = this,
                    ...
                    j = function(a, c, f, g) {
                        return '<a tabindex="0"' + ("undefined" != typeof c ? ' class="' + c + '"' : "") + ("undefined" != typeof f ? ' style="' + f + '"' : "") + (b.options.liveSearchNormalize ? ' data-normalized-text="' + d(e(a)) + '"' : "") + ("undefined" != typeof g || null !== g ? ' data-tokens="' + g + '"' : "") + ' role="option">' + a + '<span class="' + b.options.iconBase + " " + b.options.tickIcon + ' check-mark"></span></a>'
                    };
                ...
                return this.$element.find("option").each(function(d) {
                    var e = a(this);
                    if (h++, !e.hasClass("bs-title-option")) {
                        var g = this.className || "",
                            k = this.style.cssText,
                            l = e.data("content") ? e.data("content") : e.html(),
                            m = e.data("tokens") ? e.data("tokens") : null,
                            n = "undefined" != typeof e.data("subtext") ? '<small class="text-muted">' + e.data("subtext") + "</small>" : "",
                            o = "undefined" != typeof e.data("icon") ? '<span class="' + b.options.iconBase + " " + e.data("icon") + '"></span> ' : "",
                            p = e.parent(),
                            q = "OPTGROUP" === p[0].tagName,
                            r = q && p[0].disabled,
                            s = this.disabled || r;
                        if ("" !== o && s && (o = "<span>" + o + "</span>"), b.options.hideDisabled && (s && !q || r)) return void h--;
                        if (e.data("content") || (l = o + '<span class="text">' + l + n + "</span>"), q && e.data("divider") !== !0) {
                            if (b.options.hideDisabled && s) {
                            ...
                            if (0 === e.index()) {
                                ...
                                var v = p[0].label,
                                    ...
                                    x = p.data("icon") ? '<span class="' + b.options.iconBase + " " + p.data("icon") + '"></span> ' : "";
                                v = x + '<span class="text">' + v + w + "</span>", 0 !== d && c.length > 0 && (h++, c.push(i("", null, "divider", f + "div"))), h++, c.push(i(v, null, "dropdown-header" + u, f))
                            }
                            if (b.options.hideDisabled && s) return void h--;
                            c.push(i(j(l, "opt " + g + u, k, m), d, "", f))
                        } else if (e.data("divider") === !0) c.push(i("", d, "divider"));
                        else if (e.data("hidden") === !0) c.push(i(j(l, g, k, m), d, "hidden is-hidden"));
                        else {
                            var y = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName;
                            if (!y && b.options.hideDisabled)
                            ...
                            y && (h++, c.push(i("", null, "divider", f + "div"))), c.push(i(j(l, g, k, m), d))
                        }
                        b.liObj[d] = h
                    }
                    ...
                    var q, r, s, t, u, v, w, x, b = this,
                        ...
                        y = function() {
                            ...
                            b.options.container && !d.is("body") ? (h = d.offset(), h.top += parseInt(d.css("borderTopWidth")), h.left += parseInt(d.css("borderLeftWidth"))) : h = {
                                top: 0,
                                left: 0
                            }, u = c.top - h.top - e.scrollTop(), v = e.height() - u - f - h.top, w = c.left - h.left - e.scrollLeft(), x = e.width() - w - g - h.left
                        };
            ...
            liveSearchListener: function() {
                ...
                this.$button.on("click.dropdown.data-api touchstart.dropdown.data-api", function() {
                    ...
                    if (b.$searchbox.val()) {
                        var f = b.$lis.not(".is-hidden").removeClass("hidden").children("a");
                        f = b.options.liveSearchNormalize ? f.not(":a" + b._searchStyle() + '("' + d(b.$searchbox.val()) + '")') : f.not(":" + b._searchStyle() + '("' + b.$searchbox.val() + '")'), f.parent().addClass("hidden"), b.$lis.filter(".dropdown-header").each(function() {
                            var c = a(this),
                                d = c.data("optgroup");
                            0 === b.$lis.filter("[data-optgroup=" + d + "]").not(c).not(".hidden").length && (c.addClass("hidden"), b.$lis.filter("[data-optgroup=" + d + "div]").addClass("hidden"))
                        });
                        var g = b.$lis.not(".hidden");
                        g.each(function(b) {
                            var c = a(this);
                            c.hasClass("divider") && (c.index() === g.first().index() || c.index() === g.last().index() || g.eq(b + 1).hasClass("divider")) && c.addClass("hidden")
                        }), b.$lis.not(".hidden, .no-results").length ? c.parent().length && c.remove() : (c.parent().length && c.remove(), c.html(b.options.noneResultsText.replace("{0}", '"' + e(b.$searchbox.val()) + '"')).show(), b.$menuInner.append(c))
                    } else b.$lis.not(".is-hidden").removeClass("hidden"), c.parent().length && c.remove();
                    b.$lis.filter(".active").removeClass("active"), b.$searchbox.val() && b.$lis.not(".hidden, .divider, .dropdown-header").eq(0).addClass("active").children("a").focus(), a(this).focus()
                })
            },
            ...
            keydown: function(b) {
                ...
                if (g.options.liveSearch && (/(^9$|27)/.test(b.keyCode.toString(10)) && o && (b.preventDefault(), b.stopPropagation(), g.$button.click().focus()), f = a('[role="listbox"] li' + p, e), c.val() || /(38|40)/.test(b.keyCode.toString(10)) || 0 === f.filter(".active").length && (f = g.$menuInner.find("li"), f = g.options.liveSearchNormalize ? f.filter(":a" + g._searchStyle() + "(" + d(q[b.keyCode]) + ")") : f.filter(":" + g._searchStyle() + "(" + q[b.keyCode] + ")"))), f.length) {
                    ...
                    if ((/(13|32)/.test(b.keyCode.toString(10)) || /(^9$)/.test(b.keyCode.toString(10)) && g.options.selectOnTab) && o) {
                        if (/(32)/.test(b.keyCode.toString(10)) || b.preventDefault(), g.options.liveSearch) /(32)/.test(b.keyCode.toString(10)) || (g.$menuInner.find(".active a").click(), c.focus());
                        else {
                            var u = a(":focus");
        ...
        a.fn.selectpicker = g, a.fn.selectpicker.Constructor = f, a.fn.selectpicker.noConflict = function() {
            return a.fn.selectpicker = h, this
        }, a(document).data("keycount", 0).on("keydown.bs.select", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', f.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', function(a) {
            a.stopPropagation()
