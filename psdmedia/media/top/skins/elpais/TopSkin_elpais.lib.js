...
(function(namespace){
    ...
    TopSkin_elpais.prototype = new emic.top.ui.UISkinBase();

    function TopSkin_elpais (){
        ...
        var _wrapper,               // content ui layer
            ...
            _cajacompartir,         // capa que contiene enlace a las redes sociales
            ...
            _calidadBoton,          // Boton Que muestra la calidad
        ...
        var _URL_TEMPLATE = "/psdmedia/media/top/skins/elpais/assets/template.html",   // template
            _URL_STYLE = "/psdmedia/media/top/skins/elpais/assets/estilos.css",        // main style
            _URL_STYLE40 = "/psdmedia/media/top/skins/elpais/assets/estilos40.css",      // main style
            _URL_STYLE2 = "/psdmedia/media/top/skins/elpais/assets/estilos_ie8.css",   // IE8 style
        ...
        var _createRendition = function(rendition, index){      // It's used in showQuality to control option clicked...
            ...
            aelement.onclick = (function(that){
                return function(e){
                    ...
                    _selectedQField.innerHTML = rendition.label;//--cambiar el boton de Auto
                }
            })(this);
            return aelement;
        };
        var showQuality = function() {
            ...
            var Totalqualities = qualities.length - 1;

            for (i in qualities) {
                aelements[i] = _createRendition.apply(this, [qualities[i], Totalqualities - i]);
        ...
        var _asignElements = function(){
            ...
            _cajacompartir = _getElementById("cajacompartir");
            ...
            _calidadBoton = _getElementById("PlayerCalidadBoton");
            ...
            lang.addTranslations({
                "es":{"iradirecto":"Ir a directo"},
                "ca":{"iradirecto":"Ir a directe"},
                "pt-br":{"iradirecto":"Ver em direto"}
            })
            ...
            _gotolive.innerHTML = "<a style='cursor:pointer;'>" + lang.translate(window.mm_lang,"iradirecto") + "</a>";
...
//                    else{that.notifyOrderReset(_data);}
                    ...
                    _gotolive.className = _gotolive.className.replace(/playerMRSTN_parado/g,"");
        ...
        {
            if(_data.uiData.skinData.soy40!=undefined){
                soy40 = _data.uiData.skinData.soy40;
            }

            if((_data.uiData.skinData.urlshare!=undefined)&&(_data.uiData.skinData.urlshare!="default")){
                _urlshare = _data.uiData.skinData.urlshare;
            }
            ...
            document.getElementsByClassName("playerMRSTN_modulo_datos")[0].style.display = "none";
            ...
            if (_data.mediaData.title) {
                ...
                /*En caso de que el player se vea pequenio modificamos los elementos de la ventana share*/

                var minSize = document.getElementById(_data.genericData.container + "_base").offsetWidth;
                ...
                if (minSize >= 400) {
                    ...
                    _cajacompartir.setAttribute('style', 'margin:5% auto !important');
                }
            ...
            if (getDevice().mobile)
            {
                //-- Activar fullscreen solo para dispositivos Android
                ...
                //-- Logica para activar fullscreen en iPad
                //if (getDevice().agent.toLowerCase().indexOf('android') != -1 || getDevice().agent.indexOf('iPad') != -1) {
                //
                //    document.getElementsByClassName("playerMRSTN_volumen")[0].style.display = "none";
                //    //_progressBar.style.display = "none";
                //
            ...
            _progressBar.onclick = (function(that, __currentTarget){
                return function(e){
                    ...
                    _gotolive.className += " playerMRSTN_parado";
        ...
        //-- Ejecuta las renditions que nos lleguan
        this.onRenditions = function (renditions) {


            //-- En caso de que vengan las Renditions con una sola calidad no se muestra el combo
            if (renditions[0].label != "vacio") {

                _selectedQField.innerHTML = "Auto";

                _data.mediaData.renditions = renditions;

                showQuality.apply(this);

                _calidadBoton.style.display = "inline"; //-- Mostramos el combo si tiene varias rendition
        ...
        {
            if (_data.mediaData.isLiveActive){
                _gotolive.style.visibility = "visible";
            }
    ...
    namespace.TopSkin_elpais = TopSkin_elpais;
