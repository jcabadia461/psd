...
(function(namespace){
    ...
    TopSkin_los40.prototype = new emic.top.ui.UISkinBase();

      function TopSkin_los40 (){
        ...
        var _URL_TEMPLATE = "/psdmedia/media/top/skins/los40/assets/template.html",   // template
            _URL_STYLE = "/psdmedia/media/top/skins/los40/assets/estilos.css",        // main style
            _URL_STYLE2 = "/psdmedia/media/top/skins/los40/assets/estilos_ie8.css",   // IE8 style
        ...
        var setSkin = function()
        {
            ...
            _twitter.onclick = (function(that){
                return function(){
                    ...
                    if(_data.mediaData.description!="")
                        content += " - " + _data.mediaData.description;

                    if(_txt_compartir!="default")
                    switch(_txt_compartir){
                        case "premios40ballantines":
                            content = "Estoy viendo los #Premios40Ballantines y I love it! ;) via @Los40_Spain";
                            break;
                        case "backstage":
                            content = "Estoy viendo la cámara #SinFiltroBallantines";
                            break;
                        case "arribaespana":
                            content = "Yo ya estoy viendo en directo Arriba España";
                            break;
                        case "lomejordeaquiyalli":
                            content = "Estoy viendo en directo #LoMejordeAquíydeAllí";
                            break;
                    }
                    ...
                    var refer = window.location.href;
                    if(_url_compartir!="default"){refer = _url_compartir;}
...
//                    refUrl += "Los40";
        ...
        this.init = function(data){
            ...
            _url_compartir = (_data.uiData.skinData.shareurl == undefined?"default":_data.uiData.skinData.shareurl);

            _container = document.getElementById(_data.internalData.skinContainer);

            var idCSS = "";
            if((_data.uiData.skinData.idCSS!=undefined)&&(_data.uiData.skinData.idCSS!="default"))
                idCSS = _data.uiData.skinData.idCSS;

            switch(_data.uiData.skinData.udn){
                case "m80":
                    _via = "m80radio_";
                break;
                case "radiole":
            ...
            if((_data.uiData.skinData.udn)&&(this.inArray(_data.uiData.skinData.udn,["maximafm","radiole","m80","dial","los40","radioacktiva","default","los40aniversario", "tropicanacolombia"]))){
                _URL_STYLE = "/psdmedia/media/top/skins/los40/assets/" + _data.uiData.skinData.udn + "/estilos" + idCSS + ".css";
                _URL_STYLE2 = "/psdmedia/media/top/skins/los40/assets/" + _data.uiData.skinData.udn + "estilos" + idCSS + "._ie8.css";
            }
        ...
        this.onProgress = function(data){
            ...
            if (_data.mediaData.isLiveActive){
                ...
                _time_current.style.display = "none";
            }
            else {
                _totalTimeInf.style.display = "block";
                _time_current.style.display = "block";
            }
    ...
    namespace.TopSkin_los40 = TopSkin_los40;
