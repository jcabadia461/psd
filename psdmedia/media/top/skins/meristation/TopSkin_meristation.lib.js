...
(function(namespace){
    ...
    TopSkin_meristation.prototype = new emic.top.ui.UISkinBase();

      function TopSkin_meristation (){
        ...
        var _URL_TEMPLATE = "/psdmedia/media/top/skins/meristation/assets/template.html",   // template
            _URL_STYLE = "/psdmedia/media/top/skins/meristation/assets/estilos.css",        // main style
            _URL_STYLE2 = "/psdmedia/media/top/skins/meristation/assets/estilos_ie8.css",   // IE8 style
...
/*        var _callODB = function() {
            var request_data = {                                    // API rest Outbrain************************************
                permalink:"http://www.meristation.com/448267",      // url from
                widgetId: "APP_1"
            };
...
*/
        ...
        var showQuality = function() {
            ...
            //_selectedQField.style.visibility = "hidden";
...
*/
        ...
        var _loadVideos = function() {
            ...
            //_data.mediaData.relacionadosUrl = "http://fapi-top.prisasd.com/api/search/meristation/video/?order=true&size=12";
            ...
            _progressBar.onmousemove = (function(that, __currentTarget){
                return function(e) {
                    ...
                    if ((!_data.mediaData.isLive)) {
                        ...
                        if (_existsPhoto) {
                            mos.paint((xR /_progressBar.offsetWidth)*100);
    ...
    namespace.TopSkin_meristation = TopSkin_meristation;
